...
export default class Main extends React.Component {
  constructor(props) {
    ...
    this.state = {
      list: [
        {
          id: 1, name: 'Nefitari Menphusor', body: 'Lorem is not recognized as an internal or external command', stars: { ratings: 3 },
        },
        {
          id: 2, name: 'Nefitari Menphusor', body: 'Lorem is not recognized as an internal or external command', stars: { ratings: 2 },
        },
        {
          id: 3, name: 'Nefitari Menphusor', body: 'Lorem is not recognized as an internal or external command', stars: { ratings: 3 },
        },
        {
          id: 4, name: 'Nefitari Menphusor', body: 'Lorem is not recognized as an internal or external command', stars: { ratings: 2 },
        },
        {
          id: 5, name: 'Nefitari Menphusor', body: 'Lorem is not recognized as an internal or external command', stars: { ratings: 3 },
        },
        {
